...
//ArduinoMega Chess 1.0 M5Stack (Converted to M5Core2)
//engine 1.4
...
void setup() {
  ...
  M5.Lcd.setRotation(1);        // SCREEN ROTATION = 1 (landscape for M5Core2)
  definecolors();
  beep(100);
  ...
  M5.Lcd.setCursor(88,50); M5.Lcd.print("for M5Core2");
